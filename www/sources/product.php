<?php  if(!defined('_source')) die("Error");
	...
	if($id!='')
	{
		...
		//Chi tiết sản phẩm
		$sql_detail = "select id,ten$lang as ten,mota$lang as mota,noidung$lang as noidung,masp,gia,giacu,luotxem,thumb,photo,photo5,photo6,photo7,size,mausac,id_danhmuc,download,motacorr$lang as motacorr,motaprin$lang as motaprin,motawear$lang as motawear from #_product where hienthi=1 and id='$id' limit 0,1";
		$d->query($sql_detail);
	...
	{
		$sql = "select id,ten$lang as ten,title,keywords,description,photo2 from #_product_danhmuc where id='$id_danhmuc' limit 0,1";
		$d->query($sql);
		$title_bar = $d->fetch_array();
	...
	$d->reset();
	$sql = "select id,ten$lang as ten,tenkhongdau,thumb,photo,photo5,photo6,photo7,masp,gia,giacu,mota,motacorr$lang as motacorr,motaprin$lang as motaprin,motawear$lang as motawear from #_product where $where limit $bg,$pageSize";		
	$d->query($sql);
