...
<style type="text/css">
input#username, input#pass{background:none !important;}
input#username:-webkit-autofill, input#pass:-webkit-autofill,
input#username:-webkit-autofill:hover, input#pass:-webkit-autofill:hover,
input#username:-webkit-autofill:focus, input#pass:-webkit-autofill:focus,
input#username:-webkit-autofill:active, input#pass:-webkit-autofill:active {
