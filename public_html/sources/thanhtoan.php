		...
		if(mysql_query($sql))#Nếu insert bảng đơn hàng thành công
		{
			...
			if(is_array($_SESSION['cart']))
			{
				...
				for($i=0;$i<$max;$i++){
					...
					$sql = "INSERT INTO  table_chitietdonhang (madonhang,masp,ten,size,gia,soluong,tonggia,ngaytao,mausac) 
						  VALUES ('$mahoadon','$pmasp','$pname','0','$pgia','$q','$ptonggia','$ngaydangky','$color')";	
