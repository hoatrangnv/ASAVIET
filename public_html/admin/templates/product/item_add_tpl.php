...
function get_main_category()
	{
		...
		$stmt=mysql_query($sql);
		$str='
			<select id="id_cat" name="id_cat" data-placeholder="Chọn danh mục" onchange="select_onchange2()" class="main_select select_danhmuc chzn-select">
			<option></option>			
			';
		while ($row=@mysql_fetch_array($stmt)) 
		{
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
       ...
       <div id="info" class="tab_content">
		...
		<div class="formRow">
			...
			<div class="formRight">
				...
				<div class="note">  <?=_format_duoitailieu?> </div>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div class="formRow">
			...
			<div class="formRight">			
				<div class="mt10"><a href="<?=_upload_sanpham.$item['download']?>"><?=$item['download']?></a></div>
			</div>
			
			<div class="clear"></div>
			<a title="Xoá file" href="index.php?com=product&act=delete_img&id=<?=@$item['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>">Xoá file</a>
		</div>
    ...
    <?php }?>
      <div class="formRight">
        ...
        <div class="formRow">
			<label>Tải hình ảnh WEAR RESISTANCE:</label>
			<div class="formRight">
            	<input type="file" id="file" name="file5" />
				<img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
				<div class="note"> Height:60px | Width:200px  <?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
		</div>
         <?php if($_GET['act']=='edit'){?>
		<div class="formRow">
			<label>Hình Hiện Tại WEAR RESISTANCE :</label>
			<div class="formRight">
			
			<div class="mt10"><img src="<?=_upload_sanpham.$item['photo5']?>"  width="100px" alt="NO PHOTO" width="100" /></div>
        ...
        <div class="formRow">
			<label>Tải hình ảnh CORROSION RESISTANCE:</label>
			<div class="formRight">
         ...
         <?php if($_GET['act']=='edit'){?>
		<div class="formRow">
			<label>Hình Hiện Tại CORROSION RESISTANCE :</label>
			<div class="formRight">
			
			<div class="mt10"><img src="<?=_upload_sanpham.$item['photo6']?>"  width="100px" alt="NO PHOTO" width="100" /></div>
        ...
        <div class="formRow">
			<label>Tải hình ảnh PRINTING QUALITY:</label>
			<div class="formRight">
            	<input type="file" id="file" name="file7" />
				<img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
				<div class="note"> Height:60px | Width:200px  <?=_format_duoihinh_l?> </div>
			</div>
			<div class="clear"></div>
         ...
         <?php if($_GET['act']=='edit'){?>
		<div class="formRow">
			<label>Hình Hiện Tại PRINTING QUALITY:</label>
			<div class="formRight">
			
			<div class="mt10"><img src="<?=_upload_sanpham.$item['photo7']?>"  width="100px" alt="NO PHOTO" width="100" /></div>
 	...
 	<div class="formRow">
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
        ...
        <div class="formRow">
            <label>Mô tả WEAR RESISTANCE</label>
            <div class="formRight">
                <textarea  rows="8" cols="" title="Viết mô tả ngắn WEAR RESISTANCE" class="tipS" name="motawear<?=$key?>" id="motawear<?=$key?>"><?=@$item['motawear'.$key]?></textarea>
            </div>
            <div class="clear"></div>
        </div>  
        ...
        <div class="formRow">
            <label>Mô tả CORROSION RESISTANCE</label>
            <div class="formRight">
                <textarea  rows="8" cols="" title="Viết mô tả ngắn CORROSION RESISTANCE" class="tipS" name="motacorr<?=$key?>" id="motacorr<?=$key?>"><?=@$item['motacorr'.$key]?></textarea>
            </div>
            <div class="clear"></div>
        </div> 
        ...
        <div class="formRow">
            <label>Mô tả PRINTING QUALITY</label>
            <div class="formRight">
                <textarea  rows="8" cols="" title="Viết mô tả ngắn PRINTING QUALITY" class="tipS" name="motaprin<?=$key?>" id="motaprin<?=$key?>"><?=@$item['motaprin'.$key]?></textarea>
            </div>
            <div class="clear"></div>
        </div> 

        <div class="formRow">
            <label>Mô tả: <img src="./images/question-button.png" alt="Chọn loại"  class="icon_que tipS" original-title="Viết nội dung chính"> </label>
