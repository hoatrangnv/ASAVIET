...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save_danhmuc<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow ">
			<label>Tải hình ảnh đại diện trang chủ:</label>
			<div class="formRight">
		...
		<div class="formRow ">
			<label>Tải hình ảnh đại diện trang sản phẩm:</label>
			<div class="formRight">
      ...
      <a class="click_xoaanh" data-id="<?=_upload_sanpham.$item['photo2']?>" href="javascript:void(0)" >xoa file</a>
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
